...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('categories', function (Blueprint $table) {
            ...
            $table->string('name_category', 255)->unique(); // Chỉ định chiều dài 255
        ...
        Schema::create('sub_categories', function (Blueprint $table) {
            ...
            $table->string('name_sub_category', 255)->unique();
            $table->string('image_sub_category', 255);
            $table->text('description');
            $table->integer('status');
            $table->timestamps();
        });
        ...
        Schema::create('channels', function (Blueprint $table) {
            $table->id('channel_id');
            $table->foreignId('user_id')->constrained('users', 'user_id');
            $table->string('name_channel', 255)->nullable();
            $table->string('image_channel', 255);
            $table->text('address');
        ...
        Schema::create('conversation', function (Blueprint $table) {
            ...
            $table->string('receiver_type', ['user', 'staff'], 255); // 'staff' hoặc 'user'
            $table->timestamp('created_at');
